...
const backgroundImages = [
    'IMG/Inicio Fondo.png', // Índice 0: Estado inicial
    'IMG/Foto 2.png',       // Índice 1: Clic 1
    'IMG/Foto 3.png',       // Índice 2: Clic 2
    'IMG/Foto 4.png',       // Índice 3: Clic 3
    'IMG/Foto 5.png'        // Índice 4: Clic 4 (Estado final sin botón "No")
];
...
function sayYes() {
    document.body.style.backgroundImage = `url('Foto_exito.png')`; 
